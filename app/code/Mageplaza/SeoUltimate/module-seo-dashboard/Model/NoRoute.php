 ...
 */
class NoRoute extends AbstractModel implements IdentityInterface
{
    /**
     * Cache
     */
    const CACHE_TAG = 'mp_db_noroute_code';
    ...
    {
        parent::_construct();
        $this->_init('Mageplaza\SeoDashboard\Model\ResourceModel\NoRoute');
    }
