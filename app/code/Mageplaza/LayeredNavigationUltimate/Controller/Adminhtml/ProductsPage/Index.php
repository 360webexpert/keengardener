...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $this->resultPage->setActiveMenu('Mageplaza_LayeredNavigationUltimate::all_products_page');
        $this->resultPage->getConfig()->getTitle()->prepend((__('Custom Products Pages')));
